...
install_apt_deps(){
  ...
  sudo apt-get install -qq git make gcc-5 g++-5 cmake pkg-config curl libglib2.0-dev libboost-regex-dev libboost-thread-dev libboost-system-dev libboost-test-dev liblog4cxx10-dev -y
