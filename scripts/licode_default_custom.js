...
config.rabbit.url = '_rabbit_url_';
...
config.nuve.databaseSSLCertFile = '_database_ssl_cert_';
...
//     "url": url
// }
config.erizoController.iceServers = _ice_servers_; // default value: [{'url': 'stun:stun.l.google.com:19302'}]
...
config.erizoController.warning_n_rooms = 500; // default value: 15
config.erizoController.limit_n_rooms = 550; // default value: 20
...
// Use '' to automatically get IP from the interface
config.erizoAgent.publicIP = '_agent_public_ip_'; //default value: ''
