...
void WebRtcConnection::changeDeliverExtensionId(dataPacket *dp, packetType type) {
...
void WebRtcConnection::parseIncomingExtensionId(char *buf, int len, packetType type) {
  RtcpHeader* chead = reinterpret_cast<RtcpHeader*>(buf);
