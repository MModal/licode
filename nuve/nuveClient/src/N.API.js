...
N.API = (function (N) {
    'use strict';
    var createRoom, getRooms, getRoom, getRoomByName, updateRoom, patchRoom,
    ...
    getRoomByName = function (room, callback, callbackError, params) {
        send(callback, callbackError, 'GET', undefined, 'rooms/name/' + room, params);
    };
